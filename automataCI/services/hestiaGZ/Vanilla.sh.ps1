...
. "${env:LIBS_HESTIA}\hestiaGZ\Deflate.sh.ps1"
. "${env:LIBS_HESTIA}\hestiaGZ\Is_Available.sh.ps1"
...
. "${LIBS_HESTIA}/hestiaGZ/Deflate.sh.ps1"
. "${LIBS_HESTIA}/hestiaGZ/Is_Available.sh.ps1"
