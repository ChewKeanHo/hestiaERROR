...
function hestiaHOMEBREW-Is-Available {
        # execute
        if ($(hestiaOS-Is-Command-Available "brew") -ne ${env:hestiaKERNEL_ERROR_OK}) {
...
hestiaHOMEBREW_Is_Available() {
        # execute
        if [ $(hestiaOS_Is_Command_Available "brew") -ne $hestiaKERNEL_ERROR_OK ]; then
