...
. "${env:LIBS_HESTIA}\hestiaCRYPTO\Create_Random_Decimal.sh.ps1"
. "${env:LIBS_HESTIA}\hestiaCRYPTO\Create_Random_Hex.sh.ps1"
. "${env:LIBS_HESTIA}\hestiaCRYPTO\Create_Random_String.sh.ps1"
. "${env:LIBS_HESTIA}\hestiaCRYPTO\Create_Random_UUID.sh.ps1"
################################################################################
# Windows POWERSHELL Codes                                                     #
################################################################################
return
...
. "${LIBS_HESTIA}/hestiaCRYPTO/Create_Random_Decimal.sh.ps1"
. "${LIBS_HESTIA}/hestiaCRYPTO/Create_Random_Hex.sh.ps1"
. "${LIBS_HESTIA}/hestiaCRYPTO/Create_Random_String.sh.ps1"
. "${LIBS_HESTIA}/hestiaCRYPTO/Create_Random_UUID.sh.ps1"
################################################################################
# Unix Main Codes                                                              #
################################################################################
return 0
