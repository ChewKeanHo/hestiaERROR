...
function hestiaGIT-Is-Available {
        # execute
        if ($(hestiaOS-Is-Command-Available "git") -eq ${env:hestiaKERNEL_ERROR_OK}) {
...
hestiaGIT_Is_Available() {
        # execute
        if [ $(hestiaOS_Is_Command_Available "git") -eq $hestiaKERNEL_ERROR_OK ]; then
