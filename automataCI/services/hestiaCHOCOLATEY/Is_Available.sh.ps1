...
function hestiaCHOCOLATEY-Is-Available {
        # execute
        if ($(hestiaOS-Is-Command-Available "choco") -ne ${env:hestiaKERNEL_ERROR_OK}) {
...
hestiaCHOCOLATEY_Is_Available() {
        # execute
        if [ $(hestiaOS_Is_Command_Available "choco") -ne $hestiaKERNEL_ERROR_OK ]; then
