...
function hestiaCONSOLE-Log-Recreate {
        param (
                [string]$___subject,
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log info `
                "$(hestiaI18N-Translate-Recreate $___lang $___subject)`n" `
                $___lang
...
hestiaCONSOLE_Log_Recreate() {
        ...
        hestiaCONSOLE_Log info \
                "$(hestiaI18N_Translate_Recreate "$___lang" "$1")\n" \
                "$___lang"
