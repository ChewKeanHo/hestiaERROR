...
function hestiaCONSOLE-Log-Create-Simulate {
        param (
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log warning `
                "$(hestiaI18N-Translate-Create-Simulate $___lang)`n" `
                $___lang
...
hestiaCONSOLE_Log_Create_Simulate() {
        #___lang="$1"
        ...
        hestiaCONSOLE_Log warning \
                "$(hestiaI18N_Translate_Create_Simulate "$___lang")\n" \
                "$___lang"
