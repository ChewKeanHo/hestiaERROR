...
function hestiaCONSOLE-Log-Assemble-Simulate {
        param (
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log warning `
                "$(hestiaI18N-Translate-Assemble-Simulate $___lang)`n" `
                $___lang
...
hestiaCONSOLE_Log_Assemble_Simulate() {
        #___lang="$1"
        ...
        hestiaCONSOLE_Log info \
                "$(hestiaI18N_Translate_Assemble_Simulate "$___lang")\n" \
                "$___lang"
