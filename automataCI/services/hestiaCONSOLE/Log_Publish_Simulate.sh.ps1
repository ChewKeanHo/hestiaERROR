...
function hestiaCONSOLE-Log-Publish-Simulate {
        param (
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log warning `
                "$(hestiaI18N-Translate-Publish-Simulate $___lang)`n" `
                $___lang
...
hestiaCONSOLE_Log_Publish_Simulate() {
        #___lang="$1"
        ...
        hestiaCONSOLE_Log warning \
                "$(hestiaI18N_Translate_Publish_Simulate "$___lang")\n" \
                "$___lang"
