...
function hestiaCONSOLE-Log-Recreate-Simulate {
        param (
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log warning `
                "$(hestiaI18N-Translate-Recreate-Simulate $___lang)`n" `
                $___lang
...
hestiaCONSOLE_Log_Recreate_Simulate() {
        #___lang="$1"
        ...
        hestiaCONSOLE_Log warning \
                "$(hestiaI18N_Translate_Recreate_Simulate "$___lang")\n" \
                "$___lang"
