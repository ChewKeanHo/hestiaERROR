...
function hestiaCONSOLE-Log-Publish-Skipped {
        param (
                [string]$___appendix,
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log warning `
                "$(hestiaI18N-Translate-Publish-Skipped $___lang)`n" `
                $___lang `
                $___appendix
...
hestiaCONSOLE_Log_Publish_Skipped() {
        #___appendix="$1"
        #___lang="$1"
        ...
        hestiaCONSOLE_Log warning \
                "$(hestiaI18N_Translate_Publish_Skipped "$___lang")\n" \
                "$___lang" \
                "$1"
