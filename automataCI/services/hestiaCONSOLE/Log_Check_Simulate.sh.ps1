...
function hestiaCONSOLE-Log-Check-Simulate {
        param (
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log warning `
                "$(hestiaI18N-Translate-Check-Simulate "${___lang}")`n" `
                "${___lang}"
...
hestiaCONSOLE_Log_Check_Simulate() {
        #___lang="$1"
        ...
        hestiaCONSOLE_Log warning \
                "$(hestiaI18N_Translate_Check_Simulate "$___lang")\n" \
                "$___lang"
