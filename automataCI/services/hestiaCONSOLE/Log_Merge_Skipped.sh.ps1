...
function hestiaCONSOLE-Log-Merge-Skipped {
        param (
                [string]$___appendix,
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log warning `
                "$(hestiaI18N-Translate-Merge-Skipped $___lang)`n" `
                $___lang `
                $___appendix
...
hestiaCONSOLE_Log_Merge_Skipped() {
        #___appendix="$1"
        #___lang="$1"
        ...
        hestiaCONSOLE_Log warning \
                "$(hestiaI18N_Translate_Merge_Skipped "$___lang")\n" \
                "$___lang" \
                "$1"
