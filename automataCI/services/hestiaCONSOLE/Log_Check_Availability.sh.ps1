...
function hestiaCONSOLE-Log-Check-Availability {
        param (
                [string]$___subject,
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log info `
                "$(hestiaI18N-Translate-Check-Availability $___lang $___subject)`n" `
                $___lang
...
hestiaCONSOLE_Log_Check_Availability() {
        #___subject="$1"
        #___lang="$2"
        ...
        hestiaCONSOLE_Log info \
                "$(hestiaI18N_Translate_Check_Availability "$___lang" "$1")\n" \
                "$___lang"
