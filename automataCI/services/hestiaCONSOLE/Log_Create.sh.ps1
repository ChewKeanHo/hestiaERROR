...
function hestiaCONSOLE-Log-Create {
        param (
                [string]$___subject,
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log info `
                "$(hestiaI18N-Translate-Create $___lang $___subject)`n" `
                $___lang
...
hestiaCONSOLE_Log_Create() {
        ...
        hestiaCONSOLE_Log info "$(hestiaI18N_Translate_Create "$___lang" "$1")\n" "$___lang"
