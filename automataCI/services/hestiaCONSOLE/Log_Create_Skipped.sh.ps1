...
function hestiaCONSOLE-Log-Create-Skipped {
        param (
                [string]$___appendix,
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log warning `
                "$(hestiaI18N-Translate-Create-Skipped $___lang)`n" `
                $___lang `
                $___appendix
...
hestiaCONSOLE_Log_Create_Skipped() {
        #___appendix="$1"
        #___lang="$1"
        ...
        hestiaCONSOLE_Log warning \
                "$(hestiaI18N_Translate_Create_Skipped "$___lang")\n" \
                "$___lang" \
                "$1"
