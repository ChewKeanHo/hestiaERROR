...
function hestiaCONSOLE-Log-Run-Simulate {
        param (
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log warning `
                "$(hestiaI18N-Translate-Run-Simulate $___lang)`n" `
                $___lang
...
hestiaCONSOLE_Log_Run_Simulate() {
        #___lang="$1"
        ...
        hestiaCONSOLE_Log warning \
                "$(hestiaI18N_Translate_Run_Simulate "$___lang")\n" \
                "$___lang"
