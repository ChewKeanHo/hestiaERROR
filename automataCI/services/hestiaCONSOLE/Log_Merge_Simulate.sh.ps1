...
function hestiaCONSOLE-Log-Merge-Simulate {
        param (
                [string]$___lang
        )
        ...
        $null = hestiaCONSOLE-Log warning `
                "$(hestiaI18N-Translate-Merge-Simulate $___lang)`n" `
                $___lang
...
hestiaCONSOLE_Log_Merge_Simulate() {
        #___lang="$1"
        ...
        hestiaCONSOLE_Log warning \
                "$(hestiaI18N_Translate_Merge_Simulate "$___lang")\n" \
                "$___lang"
