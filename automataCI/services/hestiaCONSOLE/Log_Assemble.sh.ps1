...
function hestiaCONSOLE-Log-Assemble {
        param (
        ...
        $null = hestiaCONSOLE-Log info `
                "$(hestiaI18N-Translate-Assemble $___lang $___destination $___source)`n" `
                $___lang
...
hestiaCONSOLE_Log_Assemble() {
        ...
        hestiaCONSOLE_Log info \
                "$(hestiaI18N_Translate_Assemble "$___lang" "$1" "$2")\n" \
                "$___lang"
