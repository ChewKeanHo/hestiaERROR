...
. "${env:LIBS_HESTIA}\hestiaXZ\Deflate.sh.ps1"
. "${env:LIBS_HESTIA}\hestiaXZ\Is_Available.sh.ps1"
...
. "${LIBS_HESTIA}/hestiaXZ/Deflate.sh.ps1"
. "${LIBS_HESTIA}/hestiaXZ/Is_Available.sh.ps1"
